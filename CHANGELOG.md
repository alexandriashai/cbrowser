...
* **personas:** research-grounded behavioral patterns for accessibility ([fc590d9](https://github.com/alexandriashai/cbrowser/commit/fc590d96fd1e0ec022b87976cebf8109a41a8502))

## [10.4.2](https://github.com/alexandriashai/cbrowser/compare/v10.4.1...v10.4.2) (2026-02-07)


### Fixed

* **personas:** research-grounded behavioral patterns for accessibility ([72a9fb3](https://github.com/alexandriashai/cbrowser/commit/72a9fb318624e70b7b37780638e4cbb48ad486db))
...
* **empathy-audit:** Short persona aliases for disability types
  - Use `motor-tremor`, `low-vision`, `adhd`, `deaf`, `elderly`, `color-blind` instead of full names
  - Case-insensitive alias mapping
  - Improved error messages showing available aliases

### Documentation

* **methodology:** Research-grounded scoring with full bibliography (13 sources)
* **all features:** Disclaimers clarifying heuristic nature of scores


## [10.3.1](https://github.com/alexandriashai/cbrowser/compare/v10.3.0...v10.3.1) (2026-02-07)
...
## [10.0.1](https://github.com/alexandriashai/cbrowser/compare/v10.0.0...v10.0.1) (2026-02-07)
...
## [9.8.0](https://github.com/alexandriashai/cbrowser/compare/v9.7.0...v9.8.0) (2026-02-06)


### Added

* **mcp:** add session bridge tools for API-free persona comparison ([cbdcfbb](https://github.com/alexandriashai/cbrowser/commit/cbdcfbbc94e28328732b517ee617905ba57c3d29))
...
* **chaos:** restore network state after chaos test completes ([4ee7fd4](https://github.com/alexandriashai/cbrowser/commit/4ee7fd47a4a377ec5c101a415de7d5a2fc292226))
...
* **docker:** install all playwright browsers ([71f8bc2](https://github.com/alexandriashai/cbrowser/commit/71f8bc276f413d18d53c2445b28706524977a41d))
